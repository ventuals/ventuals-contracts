...
/// @notice Library for reading data using HyperCore precompiles
/// @dev Copied from https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/hyperevm/interacting-with-hypercore
library L1ReadLibrary {
    struct Position {
        int64 szi;
        uint64 entryNtl;
